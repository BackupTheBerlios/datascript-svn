// $ANTLR 2.7.6 (2005-12-22): "ExpressionEvaluator.g" -> "ExpressionEvaluator.java"$
...
public class ExpressionEvaluator extends antlr.TreeParser       implements ExpressionEvaluatorTokenTypes
 {
...
/******************* begin of enumerator stuff *****************/
	...
	public final IntegerValue  enumItem(AST _t,
		IntegerValue last
		...
		try {      // for error handling
			...
			case STRING_LITERAL:
			{
				...
				expression(_t);
				_t = _retTree;
				self = (IntegerValue)((Expression)e).getValue();
				break;
			}
			case 3:
			{
	...
	public final void structDeclaration(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			match(_t,STRUCT);
			_t = _t.getFirstChild();
			pushScope(((StructType)s).getScope());
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case ID:
	...
	public final void unionDeclaration(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			match(_t,UNION);
			_t = _t.getFirstChild();
			pushScope(((UnionType)u).getScope());
			{
			if (_t==null) _t=ASTNULL;
			switch ( _t.getType()) {
			case ID:
	...
	public final void paramTypeInstantiation(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			_t = __t51;
			_t = _t.getNextSibling();
			((TypeInstantiation)tmp21_AST_in).checkArguments();
		}
		catch (RecognitionException ex) {
			reportError(ex);
			if (_t!=null) {_t = _t.getNextSibling();}
	...
	public final void integerExpression(AST _t) throws RecognitionException {
		
		AST integerExpression_AST_in = (_t == ASTNULL) ? null : (AST)_t;
		AST e = null;
	...
	public final void opExpression(AST _t) throws RecognitionException {
		
		AST opExpression_AST_in = (_t == ASTNULL) ? null : (AST)_t;
		...
		try {      // for error handling
			...
			((Expression)opExpression_AST_in).evaluate();
		}
		catch (RecognitionException ex) {
			reportError(ex);
			if (_t!=null) {_t = _t.getNextSibling();}
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 2305843009213694560L, 1L, 0L, 0L};
		return data;
	}
